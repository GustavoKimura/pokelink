...
import { createPlayerSlice } from "./parts/createPlayerSlice";
import { createMapSlice } from "./parts/createMapSlice";
import { createBattleSlice } from "./parts/createBattleSlice";
...
export const useGameViewModel = create<StoreState>()(
  devtools((...a) => ({
    ...createGameSlice(...a),
    ...createPlayerSlice(...a),
    ...createMapSlice(...a),
